...
export default function Hero() {
  return (
    <section className="relative flex min-h-[72vh] items-center overflow-hidden bg-[#003366] text-white md:min-h-[88vh]">
      <Image
        src="/images/experiences/everest-breakfast.jpg"
        alt="Mountain Helicopters Nepal aircraft flying towards the Everest region"
        fill
        priority
        sizes="100vw"
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#001A33] via-[#003366]/70 to-[#003366]/25" />
