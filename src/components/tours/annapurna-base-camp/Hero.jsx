...
const tourTabs = [
  ...
  { label: "ANNAPURNA BASE CAMP", href: "/tours/annapurna-base-camp",active: true },
  { label: "GOSAIKUNDA LAKE", href: "/tours/gosaikunda-lake" }, 
];

export default function AnnapurnaBaseCamp() {
  return (
    <div
      className="relative bg-cover bg-center bg-no-repeat pt-[75px]"
      style={{
        backgroundImage: "url('/images/annapurna-base-camp/annapurna-base-camp.jpg')",
      }}
    >
      ...
      <section className="relative z-10 min-h-[560px] py-16 sm:py-20 lg:h-[calc(100vh-168px)] lg:py-0">
        <div className="mx-auto flex h-full max-w-[1250px] items-center px-4 sm:px-5 md:px-8">
          <div className="max-w-[900px]">
            ...
            <h1 className="font-fraunces font-bold leading-[0.95] tracking-[-1.5px] text-[#FFFFFF] text-[42px] sm:text-[68px] md:text-[88px] lg:text-[104px] xl:text-[83px] sm:tracking-[-2.83px]">
            ...
            <p className="mt-6 max-w-[540px] font-manrope text-[17px] font-bold leading-[1.45] text-white sm:mt-7 sm:text-[20px] md:text-[20px] tracking-normal">
              Witness the majestic Annapurna range from an unforgettable aerial perspective, 
              flying deep into the heart of the Himalayas toward Annapurna Base Camp.
