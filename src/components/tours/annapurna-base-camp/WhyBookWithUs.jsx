      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-5 font-fraunces text-3xl font-semibold leading-tight tracking-[-0.02em] text-white md:text-4xl lg:text-5xl">
            Five reasons to book your Annapurna flight{" "}
          ...
          <p className="mx-auto mt-5 max-w-4xl font-manrope text-sm leading-7 text-white/55">
            Fly directly from Pokhara or Kathmandu into the Annapurna Sanctuary
            with a licensed helicopter operator, experienced mountain pilots
            and clearly explained services from booking to landing.
          </p>
        </div>
