...
function PriceCard({ plan }) {
  return (
    <div
      className={`group relative flex min-h-[650px] w-full max-w-[430px] flex-col overflow-visible border bg-white px-6 py-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_28px_70px_rgba(0,51,102,0.16)] sm:px-8 sm:py-10 ${
        plan.featured
      ...
      <div className="mx-auto w-full max-w-[940px]">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-[680px] font-manrope text-[14px] leading-7 text-[#7b8795] sm:text-[15px]">
            Join a scheduled shared-seat departure or reserve the complete
            helicopter for a private journey into the Annapurna Sanctuary.
          </p>
        </div>
