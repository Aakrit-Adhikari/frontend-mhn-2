  ...
  return (
    ...
    >
      ...
      <div className="relative z-[2] max-w-[820px] px-6 pb-24 pt-20 text-center">
        ...
        <h2
          className={`mb-6 font-fraunces text-[clamp(2.4rem,6vw,4.2rem)] font-extrabold leading-[1.05] text-white transition-all duration-[850ms] delay-[280ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] ${
