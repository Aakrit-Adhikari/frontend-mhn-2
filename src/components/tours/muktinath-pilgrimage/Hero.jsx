...
const tourTabs = [
  ...
  { label: "MUKTINATH PILGRIMAGE", href: "/tours/muktinath-pilgrimage",active: true },
...
export default function MuktinathTemple() {
  return (
    <div
        ...
        <div className="mx-auto flex h-full max-w-[1250px] items-center px-4 sm:px-5 md:px-8">
          <div className="max-w-[900px]">
            ...
            <p className="mt-6 max-w-[540px] font-manrope text-[17px] font-bold leading-[1.45] text-white sm:mt-7 sm:text-[20px] md:text-[20px] tracking-normal">
              This speedy trip saves you from the bodily fatigue and the day
              time that goes into the normal multi-day trek through the
              Himalayas.
            </p>
