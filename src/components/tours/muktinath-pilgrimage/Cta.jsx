  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: "url('/images/muktinath-pilgrimage/muktinath.jpg')" }}
      />
      ...
      <div className="relative z-[2] max-w-[820px] px-6 pb-24 pt-20 text-center">
        ...
        <h2
          className={`mb-6 font-fraunces text-[clamp(2.4rem,6vw,5.2rem)] font-extrabold leading-[1.05] text-white transition-all duration-[850ms] delay-[280ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] ${
            visible ? "translate-y-0 opacity-100" : "translate-y-9 opacity-0"
          }`}
        >
          Muktinath Temple is <span className="text-[#f5a623]">waiting.</span>
        </h2>

        <p
          className={`mx-auto mb-10 max-w-[560px] font-manrope text-[clamp(0.9rem,1.6vw,1.05rem)] font-light leading-[1.75] text-white/65 transition-all duration-700 delay-[480ms] ${
            visible ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"
          }`}
        >
          Fly across Pokhara, Jomsom, Mustang, Annapurna, and Dhaulagiri to
          complete your sacred Muktinath pilgrimage in comfort and safety.
        </p>
