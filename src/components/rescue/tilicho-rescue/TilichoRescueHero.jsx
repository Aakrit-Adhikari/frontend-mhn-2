  ...
  return (
    <section className="relative overflow-hidden bg-[#061523] text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -right-40 top-0 h-[500px] w-[500px] rounded-full bg-[#0d2940]/35 blur-3xl" />
       ...
       <div className="mx-auto grid min-h-[730px] max-w-[1440px] items-center gap-12 px-5 pb-16 pt-24 sm:px-8 sm:pb-20 sm:pt-28 lg:grid-cols-[1fr_300px] lg:px-12 lg:pb-20 lg:pt-32 xl:px-[80px] 2xl:px-[125px]">
        ...
        <div className="max-w-[900px]">
          <p className="font-manrope text-[10px] font-bold uppercase tracking-[0.24em] text-[#f2a10d]">
            — Tilicho Region // 24/7 Helicopter Rescue
          </p>
          ...
          <h1 className="mt-7 max-w-[900px] font-fraunces text-[48px] font-semibold leading-[0.98] tracking-[-0.035em] text-[#f6f2ea] sm:text-[62px] lg:text-[76px] xl:text-[84px]">
            <span className="italic text-[#f2a10d]">Tilicho</span>{" "}
            <span>Helicopter</span>

            <span className="block">Rescue &amp; Emergency</span>

            <span className="block">Evacuation Services</span>

            <span className="block">in Manang</span>
          </h1>

          <p className="mt-8 max-w-[780px] font-manrope text-[15px] leading-7 text-white/75 sm:text-[17px] sm:leading-8">
            Tilicho helicopter rescue provides emergency medical evacuation for
            trekkers, guides, porters and expedition members facing altitude
            illness, injury, severe weather or other urgent conditions across
            the Tilicho and Manang region. Rescue may be coordinated from
            Tilicho Base Camp, Khangsar, Shree Kharka, Manang, Tilicho Lake and
            nearby high-altitude trekking routes.
          </p>
          ...
          <div className="mt-10">
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
              ...
              <a
                href="tel:+9779712082949"
                className="font-fraunces text-[31px] font-semibold text-[#f6f2ea] transition-colors hover:text-[#f2a10d] sm:text-[38px]"
              >
                +977-9712082949
              </a>
            </div>
          ...
          <div className="mt-8 grid max-w-[820px] gap-4 border-t border-white/10 pt-6 sm:grid-cols-3">
            <div>
              ...
              <p className="mt-2 font-manrope text-[11px] leading-[1.6] text-white/65">
                Kathmandu or Pokhara according to aircraft position
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 font-manrope text-[11px] leading-[1.6] text-white/65">
                Tilicho Base Camp, Khangsar, Shree Kharka and Manang
              </p>
            </div>
          ...
          <div className="mt-7 space-y-2 font-manrope text-[11px] leading-5 tracking-[0.03em] text-[#8794a0] sm:text-[12px]">
            ...
            <p>
              Share the patient&apos;s exact location, altitude, symptoms,
              insurance details and nearest safe landing point.
            </p>
          </div>
        </div>
