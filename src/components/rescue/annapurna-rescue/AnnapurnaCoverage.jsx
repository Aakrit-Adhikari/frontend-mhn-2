      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="max-w-[980px]">
          ...
          <p className="mt-5 max-w-[760px] font-manrope text-[11px] leading-[1.8] text-[#4d5963] sm:text-[12px]">
            ...
            gaining more than 5,000 metres in elevation along the way. Rescue
            conditions change significantly at each stage of the route.
          </p>
        </div>
          ...
          <table className="w-full min-w-[760px] border-collapse font-manrope text-left">
            <thead>
              <tr className="bg-[#061523] text-white">
                ...
                <th className="px-4 py-3 text-[8px] font-bold uppercase tracking-[0.18em]">
                  Elevation
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              {rescuePoints.map((point) => {
                ...
                return (
                  ...
                  >
                    <td className="border-x border-[#d5d7d6] px-4 py-3 font-manrope text-[10px] font-medium text-[#071825]">
                      {point.location}
                    </td>

                    <td className="border-r border-[#d5d7d6] px-4 py-3 text-right font-manrope text-[10px] font-semibold text-[#071825]">
                      {formatAltitude(point.altitude)}
                    </td>

                    <td className="border-r border-[#d5d7d6] px-4 py-3">
                      <div className="h-[7px] w-full max-w-[520px] overflow-hidden bg-[#eee9df]">
                        <div
        ...
        <div className="mt-8 grid gap-4 border-t border-[#d5d7d6] pt-6 sm:grid-cols-3">
          <p className="font-manrope text-[10px] leading-[1.7] text-[#5b6872]">
            Lower trail points generally allow greater aircraft payload and
            more flexible landing options.
          </p>

          <p className="font-manrope text-[10px] leading-[1.7] text-[#5b6872]">
            Above 4,000 metres, weather, wind and reduced air density can
            significantly affect aircraft performance.
          </p>

          <p className="font-manrope text-[10px] leading-[1.7] text-[#5b6872]">
            Thorong La and other exposed high points may require reduced
            payload, shuttle operations or transfer to a safer nearby pickup
            point.
          </p>
        </div>
      </div>
