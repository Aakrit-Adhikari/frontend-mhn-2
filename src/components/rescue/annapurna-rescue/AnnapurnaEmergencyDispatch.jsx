// src/components/rescue/annapurna/AnnapurnaEmergencyDispatch.jsx

import { Mail, MessageCircle, Phone } from "lucide-react";

export default function AnnapurnaEmergencyDispatch() {
  return (
    <section className="bg-[#061523] text-white">
      <div className="mx-auto flex min-h-[550px] max-w-[1440px] flex-col items-center justify-center px-5 py-20 text-center sm:px-8 lg:px-12 xl:px-[80px] 2xl:px-[125px]">
        <p className="font-manrope text-[9px] font-bold uppercase tracking-[0.24em] text-[#f2a10d]">
          — Emergency Dispatch
        </p>

        <h2 className="mt-6 max-w-[820px] font-fraunces text-[40px] font-semibold leading-[0.98] tracking-[-0.03em] text-[#f6f2ea] sm:text-[54px] lg:text-[68px]">
          Call the operator who
          <span className="block">has flown </span>
          <span className="block italic text-[#f2a10d]">
            Himalayan rescues since 2009
        ...
        <div className="mt-7 flex w-full max-w-[760px] flex-col justify-center gap-3 sm:flex-row">
          ...
          <a
            ...
            className="inline-flex min-h-[42px] flex-[1.5] items-center justify-center gap-2 border border-white/45 px-5 font-manrope text-[10px] font-bold uppercase tracking-[0.12em] text-white transition hover:border-white"
          >
            <span>[</span>
            <Mail size={14} />
      ...
      <div className="border-t border-white/10 bg-[#05111f] px-5 py-6 text-center sm:px-8">
        <p className="font-fraunces text-[26px] font-semibold italic leading-none text-[#466181] sm:text-[32px] lg:text-[36px]">
