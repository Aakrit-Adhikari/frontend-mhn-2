// src/components/rescue/annapurna/AnnapurnaWhatsCovered.jsx
...
function IncludedItem({ children }) {
  return (
    <li className="flex items-start gap-3 font-manrope text-[11px] leading-[1.7] text-[#46545f] sm:text-[12px]">
      <span className="mt-[1px] font-manrope text-[14px] font-bold text-[#2f8b68]">
        ✓
      </span>
...
function ExcludedItem({ children }) {
  return (
    <li className="flex items-start gap-3 font-manrope text-[11px] leading-[1.7] text-[#56626c] sm:text-[12px]">
      <span className="mt-[1px] font-manrope text-[14px] font-bold text-[#71808b]">
        ×
      </span>
        ...
        <div className="mx-auto grid max-w-[1440px] items-center gap-10 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-4 max-w-[760px] font-manrope text-[11px] leading-[1.75] text-white/70 sm:text-[12px]">
              ...
              insurance details. We coordinate; the pilot makes the final
              go/no-go decision on flight safety.
            </p>
          </div>
