// src/components/rescue/EmergencyDispatch.jsx
...
export default function EmergencyDispatch() {
  return (
    <section className="bg-[#061523] text-white">
      <div className="mx-auto flex min-h-[720px] max-w-[1440px] flex-col items-center justify-center px-5 py-20 text-center sm:px-8 lg:px-12 xl:px-[80px] 2xl:px-[125px]">
        <p className="font-manrope text-[9px] font-bold uppercase tracking-[0.24em] text-[#e69a0d]">
          — Emergency Dispatch
        </p>

        <h2 className="mt-6 max-w-[900px] font-fraunces text-[42px] font-semibold leading-[0.98] tracking-[-0.03em] text-[#f6f2ea] sm:text-[56px] lg:text-[72px]">
          Call the operator who
          <span className="block">
            has flown{" "}
            <span className="italic text-[#f2a10d]">Himalayan</span>
          </span>
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <span className="font-manrope text-[10px] font-bold uppercase tracking-[0.2em] text-white/80">
            24/7 Operational
          </span>
        </div>
        ...
        <a
          ...
          className="mt-8 inline-flex min-h-[54px] items-center justify-center gap-3 bg-[#c85d00] px-7 font-manrope text-white transition hover:bg-[#df6b00] sm:px-10"
        >
        ...
        <div className="mt-7 flex w-full max-w-[720px] flex-col justify-center gap-3 sm:flex-row">
          <a
      ...
      <div className="border-t border-white/15 px-5 py-7 text-center sm:px-8">
        <p className="font-fraunces text-[28px] font-semibold italic leading-none text-[#466181] sm:text-[34px] lg:text-[40px]">
          Above the mountains. When it matters most.
        </p>
      </div>
    </section>
  );
